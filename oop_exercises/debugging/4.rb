...
class Employee
  ...
  protected
  # this was private beforehand, which cannot be invoked with an explicit caller, 
  # even inside its own class, which is what we do above on line 56
  # When made into a protected method, we can utilize the method explicitly from within the class
